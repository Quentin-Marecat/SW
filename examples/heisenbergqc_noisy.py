...
SWQC = HeisenbergQC(nb_sites,nb_sites,J_matrix,trial_state = None,verbose=True,Ly=Ly,noisy=noisy,BC=BC,mode=mode)
SWQC.kernel(solve_heisenberg=solve_heisenberg,S2_subspace=S2_subspace)
print("%"*50+'\n')
